...
estimates16 <- state_df[c(1:3)]
estimates16 <- estimates16 %>%
...
### Saving estimates
write.csv(estimates16, '/Users/jordanschmidt/Desktop/POLS4716/Final Project /Datasets/2016estimates.csv', row.names = TRUE)
